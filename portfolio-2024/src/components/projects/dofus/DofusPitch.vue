...
<template>
  ...
  <space-paragraph>
    ...
    professions, <bold-element>craft</bold-element> and <bold-element>sell</bold-element> items, own a house or a haven bag, and <bold-element>join a guild</bold-element> to participate in
    alliance wars.
  </space-paragraph>
