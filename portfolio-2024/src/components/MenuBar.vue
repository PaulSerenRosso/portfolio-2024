...
<template>
  ...
  <div v-if="this.checkPlatformDeviceIdForRenderMobileMenuBar" id="_menuBarMobilePopUp" :class="`menu-bar-mobile-pop-up-${this.mobileMenuButtonState}`">
    <router-link v-on:click="this.goToPage()" to="/" class="menu-bar-button menu-bar-mobile-button">{{this.aboutMeName}}</router-link>
  ...
  <router-link v-on:click="this.goToPage()" to="/contacts" class="menu-bar-button menu-bar-mobile-button">
    {{this.contactName}}</router-link>
  </div>
  <div id="_menuBarContainer">
    ...
    <div id="_menuBarDesktop" v-if="!this.checkPlatformDeviceIdForRenderMobileMenuBar" >
      ...
      <router-link v-on:click="this.goToPage()" to="/" class="menu-bar-button menu-bar-desktop-button">{{this.aboutMeName}}</router-link>
      ...
      <router-link v-on:click="this.goToPage()" to="/contact" class="menu-bar-contact-desktop">
        <main-button :delay="1000" key-event="">
          {{this.contactName}}
        </main-button>
      </router-link>
      </div>
